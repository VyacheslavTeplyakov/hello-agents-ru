...
<div align="center">
  <img src="https://raw.githubusercontent.com/datawhalechina/Hello-Agents/main/docs/images/8-figures/8-2.png" alt="Архитектура системы памяти и RAG в HelloAgents" width="95%"/>
  <p>Рисунок 8.2 Общая архитектура системы памяти и RAG в HelloAgents</p>
</div>
...
<div align="center">
  <img src="https://raw.githubusercontent.com/datawhalechina/Hello-Agents/main/docs/images/8-figures/8-3.png" alt="Процесс формирования памяти" width="90%"/>
...
<div align="center">
  <img src="https://raw.githubusercontent.com/datawhalechina/Hello-Agents/main/docs/images/8-figures/8-4.png" alt="Рабочий процесс системы памяти" width="95%"/>
  <p>Рисунок 8.4 Полный рабочий процесс системы памяти HelloAgents</p>
</div>
...
<div align="center">
  <img src="https://raw.githubusercontent.com/datawhalechina/Hello-Agents/main/docs/images/8-figures/8-5.png" alt="Ключевой принцип системы RAG" width="85%"/>
  <p>Рисунок 8.5 Ключевой принцип работы системы RAG</p>
</div>
...
```
Стандартный Markdown → парсинг иерархии заголовков → семантическая сегментация абзацев → разбиение по токенам → оптимизация стратегии перекрытия → подготовка к векторизации
       ↓                ↓              ↓            ↓           ↓            ↓
   Единый формат      #/##/###      Семантические  Контроль   Непрерывность  Векторное
   Чёткая структура  Распознавание  границы        размера    информации     представление
                     иерархии       Целостность    Оптимизация Сохранение    Семантический
                                                   поиска     контекста      поиск
```
...
<div align="center">
  ...
  <p>Рисунок 8.6 Пятишаговый рабочий процесс интеллектуального ассистента для работы с документами</p>
</div>
